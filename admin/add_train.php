...
<div class="forms">
    <form action="add_train.php" method="post">
        ...
        Source : <input type="text" name="src" required placeholder = "Source"><br>
        Destination : <input type="text" name="dest" required placeholder = "Enter Destination"><br>
        Train Date   : <input type="date" id = "train_date" required name="train_date" value = '$today' min = '$today' placeholder = "Enter date of departure"><br>
        AC Coaches : <input type="number" name="ac_coach" required placeholder = "Enter no. of AC coaches"><br>
        Sleeper Coaches : <input type="number" name="sleeper_coach" required placeholder = "Enter no. of Slepper coaches"><br>
